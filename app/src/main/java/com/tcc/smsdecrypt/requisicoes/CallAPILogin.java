...
public class CallAPILogin extends AsyncTask<String, String, String> {

    Context context;
    String email = "";
    public CallAPILogin(Context c, String email){
        ...
        try {
            ...
            try {
                ...
                handler.post( new Runnable(){
                    public void run(){
                        Toast.makeText(context, "Enviando código de verificação ...", Toast.LENGTH_LONG).show();
                    }
                });
                HttpURLConnection c = (HttpURLConnection) new URL("http://186.248.79.46:9201/recuperarSenha").openConnection();
